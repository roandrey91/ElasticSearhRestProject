...
public class CodeAndDescriptionResponse {

	private static final String SUCCES_IMPORT_DESCRIPTION = "Successfu; import.";
	...
	public CodeAndDescriptionResponse(int code) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CodeAndDescriptionResponse other = (CodeAndDescriptionResponse) obj;
		if (code != other.code)
			return false;
		if (text == null) {
			if (other.text != null)
